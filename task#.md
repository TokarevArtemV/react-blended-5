...
- Створити сторінки `Home` `Rates` і компонент `Header`
...
- Використовуючи `createAsyncThunk` потрібно створити thunk для відправки запиту на бекенд для отримання актуальних курсів валют відносно `baseCurrency`
...
- З масиву масивів (так як ми використовували Object.entries()) потрібно створити масив
  об'єктів, щоб було зручно відображати розмітку.
